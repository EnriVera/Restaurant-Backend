...
CREATE TABLE "People" (
    ...
    "id_google" UUID DEFAULT gen_random_uuid(),
...
CREATE TABLE "Owner" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "id_people" UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "Waiter" (
    ...
    "id_restaurant" UUID NOT NULL DEFAULT gen_random_uuid(),
    "id_people" UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "Table" (
    ...
    "id_restaurant" UUID NOT NULL DEFAULT gen_random_uuid(),
    "id_waiter" UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "Addition" (
    ...
    "id_table" UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE "Additionproduct" (
    ...
    "id_addition" UUID NOT NULL DEFAULT gen_random_uuid(),
